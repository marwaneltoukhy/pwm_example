...
async def pwm_servo_test(dut):
    ...
    async def measure_pwm_pulse(pin, timeout_cycles=500000):
        ...
        for _ in range(timeout_cycles):
            ...
            cocotb.log.warning(f"Timeout waiting for PWM rising edge")
            return 0
        ...
        for _ in range(timeout_cycles):
            ...
            cocotb.log.warning(f"Timeout waiting for PWM falling edge")
            return 0
    ...
    result2 = await verify_pwm_range(pwm1_pin, "PWM1", 16000, 20000)
    result3 = await verify_pwm_range(pwm2_pin, "PWM2", 16000, 20000)
    result4 = await verify_pwm_range(pwm3_pin, "PWM3", 16000, 20000)
    ...
    result6 = await verify_pwm_range(pwm1_pin, "PWM1", 4000, 8000)
    result7 = await verify_pwm_range(pwm2_pin, "PWM2", 4000, 8000)
    result8 = await verify_pwm_range(pwm3_pin, "PWM3", 4000, 8000)
    ...
    result10 = await verify_pwm_range(pwm1_pin, "PWM1", 16000, 20000)
    result11 = await verify_pwm_range(pwm2_pin, "PWM2", 16000, 20000)
    result12 = await verify_pwm_range(pwm3_pin, "PWM3", 16000, 20000)
    ...
    result14 = await verify_pwm_range(pwm1_pin, "PWM1", 28000, 32000)
    result15 = await verify_pwm_range(pwm2_pin, "PWM2", 28000, 32000)
    result16 = await verify_pwm_range(pwm3_pin, "PWM3", 28000, 32000)
