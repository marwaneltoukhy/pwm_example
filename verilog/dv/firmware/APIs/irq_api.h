...
*/
/*
 * Modified by Youssef Kandil at nativechips.ai
 */
...
#include "defs.h"     // for reg_user*_irq_en, reg_timer0_irq_en, reg_uart_*, etc
#include "irq_vex.h"  // for irq_setmask, irq_setie, irq_getmask
#include "soc.h"      // for *_INTERRUPT constants
// IRQ 
